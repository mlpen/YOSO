...
class Attention(nn.Module):
    def __init__(self, config):
        ...
        elif self.attn_type == "yoso-v1-e":
            from efficient_attentions.yoso.yoso_v1.yoso import YOSOEAttention
            self.attn = YOSOEAttention(config)
        elif self.attn_type == "yoso-v1":
            from efficient_attentions.yoso.yoso_v1.yoso import YOSOAttention
            self.attn = YOSOAttention(config)
        elif self.attn_type == "yoso-v2":
            from efficient_attentions.yoso.yoso_v2.yoso import YOSOAttention
            self.attn = YOSOAttention(config)
        ...
        elif self.attn_type == "longformer":
            from efficient_attentions.attention_longformer import LongformerAttention
    ...
    def forward(self, X, mask):
        ...
        if self.attn_type in ["longformer", "reformer"]:
